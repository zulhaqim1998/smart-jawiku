...
class Slide6Menu extends React.Component {
    ...
    render() {
        ...
        const tajuk = 'Perbezaan Huruf & Sebutannya';
        return (
            <View style={{flex: 1}}>
                <ImageBackground  source={require('jawiku/images/HomeScreen/background4.jpg')} style={{
                    ...
                    <TouchableOpacity style={styles.button} onPress={() => navigate('Slide5Video', {videoLocation: require('jawiku/video/slide6-1.mp4'), tajuk})}>
