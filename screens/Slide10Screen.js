...
class Slide10Screen extends React.Component {
    ...
    render() {
        return (
            <View style={styles.container}>
                <Text style={{fontSize: 16}}>Padankan huruf yang sama bentuk.</Text>
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    <RNSketchCanvas
                        localSourceImage={{
                            filename: 'slide10.png',  // e.g. 'image.png' or '/storage/sdcard0/Pictures/image.png'
