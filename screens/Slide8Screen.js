...
class Slide8Screen extends React.Component {
    ...
    render() {
        return (
            <View style={styles.container}>
                <Text style={{fontSize: 16}}>Tulis huruf jawi dalam ruang yang disediakan.</Text>
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    <RNSketchCanvas
                        localSourceImage={{
                            filename: 'slide8.png',  // e.g. 'image.png' or '/storage/sdcard0/Pictures/image.png'
